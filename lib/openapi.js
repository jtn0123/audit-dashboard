...
const spec = {
  ...
  paths: {
    ...
    '/api/settings/access': { get: { summary: 'Live probe of what the current token can see — {access: {metadata|dependabot_alerts|pull_requests|contents|actions|administration: ok|denied|unknown}}', responses: { ...jsonResponse('Per-permission probe results'), ...NOT_CONFIGURED } } },
