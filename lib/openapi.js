  ...
  paths: {
    ...
    '/api/gh/actions': {
      get: {
        ...
        description: 'One entry per executable step: {type: merge_pr|close_superseded|enable_alerts|enable_security_updates|add_dependabot_config|flag_pr, repo, pr?, verdict, why, command, preconditions?, risk}. Freshness fields ride on the envelope; when stale=true, POST /api/gh/refresh first.',
